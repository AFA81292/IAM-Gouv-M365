...
### 01_User_Management
* [Exo 1 : Création d'un rôle personnalisé](./01_User_Management/exo1.ps1)
  * Objectif : Déploiement d'un rôle RBAC granulaire pour la création d'applications.
  * Licence requise : Entra ID P1/P2.
* [Exo 2 : Création unitaire d'un utilisateur](./01_User_Management/exo2.ps1)
  * Objectif : Provisioning unitaire d'un utilisateur via Graph API.
* [Exo 2bis : Création d'utilisateurs en masse](./01_User_Management/exo2bis.ps1)

...
* [Exo 6b : Content Search — mailbox ciblée, date range, mot-clé](./06_Audit_ContentSearch/exo6b-content-search.ps1)
  ...
  * Connexion requise : `Connect-IPPSSession` (deux sessions séquentielles — voir note technique double session)
...
```powershell
# IMPORTANT : Get-UnifiedAuditLogRetentionPolicy ne supporte pas -Identity
